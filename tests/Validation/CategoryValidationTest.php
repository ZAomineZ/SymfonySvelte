...
class CategoryValidationTest extends WebApplicationTestCase
{
    /**
     * @var KernelBrowser
     */
    ...
    public function testFailureFieldContentTooShort()
    {
        ...
        $this->assertEquals(false, $response['success']);
        $this->assertEquals('Error validation, check your incorrect fields !', $response['message']);
        $this->assertIsBool(in_array('This value is too short. It should have 15 characters or more.', $errors));
    }
}